...
const SHOULD_FLAG = [
  ...
  // 8. Dotenv bare value with trailing inline comment (common in .env.production)
  { desc: 'dotenv bare value with inline comment', line: 'ENCRYPTION_SECRET=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa # generated by setup' },
];
...
const SHOULD_NOT_FLAG = [
  ...
  // Guard script regex source — variable name inside regex literal, not an assignment
  { desc: 'guard script regex source (self-check)', line: '/\\b(?:ENCRYPTION_SECRET|TOKEN_HMAC_SECRET)\\b\\s*[:=]\\s*/g' },
];
