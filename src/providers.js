...
/**
 * pingProvider — unauthenticated HEAD/GET to a provider's models listing.
...
module.exports = { forwardRequest, SUPPORTED_PROVIDERS, validateAndNormaliseBaseUrl, pingProvider };
